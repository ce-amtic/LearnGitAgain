...
enable CrashBlockAimed system     [dev]
  ...
  2. KeyBit SlightAjustment system under inspection  [disappointing]
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
0xdc17 : 19(lv) / 56(lv)
*/
void Adjust(unsigned char *buffer, int index){
  switch(rand() % 3){
    case 0:
